...
First we will have to acquire or create an image to draw. For this tutorial use the following image, from http://millionthvector.blogspot.com/p/free-sprites.html:
